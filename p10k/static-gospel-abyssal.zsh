# Static Gospel Abyssal - powerlevel10k
# Source this AFTER ~/.p10k.zsh (it overrides the generated config's colors):
#   [[ -f ~/.config/zsh/static-gospel-abyssal.zsh ]] && source ~/.config/zsh/static-gospel-abyssal.zsh
#
...
typeset -g POWERLEVEL9K_TERRAFORM_FOREGROUND='#ff8506'
