# Static Gospel - powerlevel10k
# Source this AFTER ~/.p10k.zsh (it overrides the generated config's colors):
#   [[ -f ~/.config/zsh/static-gospel.zsh ]] && source ~/.config/zsh/static-gospel.zsh
#
...
typeset -g POWERLEVEL9K_FOREGROUND='#dbdcf2'
...
typeset -g POWERLEVEL9K_DIR_FOREGROUND='#f5f5ff'
typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#6e7487'
typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#f5f5ff'
typeset -g POWERLEVEL9K_KUBECONTEXT_FOREGROUND='#66e4fd'
typeset -g POWERLEVEL9K_TERRAFORM_FOREGROUND='#e87500'
typeset -g POWERLEVEL9K_TERRAFORM_BACKGROUND='#21202e'
