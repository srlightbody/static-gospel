...
local function set_highlights()
	...
	local legacy_highlights = {
		...
		["@class"] = { fg = palette.aether_dim },
		["@conditional"] = { link = "Conditional" },
		["@field"] = { fg = palette.aether_dim },
		["@include"] = { link = "Include" },
		["@interface"] = { fg = palette.aether_dim },
		["@macro"] = { link = "Macro" },
	...
	local default_highlights = {
		...
		SpecialKey = { fg = palette.aether_dim },
		...
		htmlTagName = { fg = palette.aether_dim },
		...
		["@variable.member"] = { fg = palette.aether_dim },
		...
		["@type"] = { fg = palette.aether_dim },
		["@type.builtin"] = { fg = palette.aether_dim, bold = styles.bold },
		-- ["@type.definition"] = {},

		["@attribute"] = { fg = palette.umbra },
		["@attribute.builtin"] = { fg = palette.umbra, bold = styles.bold },
		["@property"] = { fg = palette.aether_dim, italic = styles.italic },
		...
		["@constructor"] = { fg = palette.aether_dim },
		...
		["@keyword.storage"] = { fg = palette.aether_dim },
